...
class UsersController extends Controller
{
    ...
    public function store(Request $request){
      $rules = [
        ...
        $this->password => $this->isNullableString.'|confirmed',
      ...
      $password = $request->input($this->password) !== null ? Hash::make($request->input($this->password)) : Hash::make($autoGeneratedPassword);
